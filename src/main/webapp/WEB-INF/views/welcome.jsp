    ...
    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}@example.com
                                                        </p>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@example.com</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
                      ...
                      <%
                          ...
                          String username = auth != null ? auth.getName() : "to the Accounts App";
                      %>
